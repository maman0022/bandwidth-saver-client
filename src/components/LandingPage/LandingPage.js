...
function LandingPage() {
  if (!FingerprintService.getFingerprint()) {
    FingerprintService.generateAndSaveFingerprint()
  }
  ...
  return (
    <section className='flex-column full-height justify-evenly'>
      ...
      <p className='lp-paragraph'>If you register, your limit will be increased to 10 files per hour.</p>
